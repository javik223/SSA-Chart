...
/**
 * ChartRenderer - Standalone component for rendering charts from exported data
 * This component is used in the /render page to display charts loaded from JSON exports
 */
    ...
    return (
      <div className="flex items-center justify-center h-96 bg-zinc-100 dark:bg-zinc-900 rounded-lg">
        <p className="text-zinc-500 dark:text-zinc-400">
          No chart data available. Please load a chart configuration.
        </p>
      </div>
    );
  }
